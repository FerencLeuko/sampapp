...
public class GlobalControllerAdvice extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<ErrorResponse> handleRuntimeExceptions( RuntimeException ex){
        ...
        return new ResponseEntity<ErrorResponse>(ErrorResponse.builder().message("Something went wrong, please try again later.").build(),HttpStatus.INTERNAL_SERVER_ERROR);
    }
